  ...
  <div class="d-flex justify-content-center">
    <div class="col-lg-5 col-xl-4 p-12 p-xl-20 position-fixed start-0 top-0 h-screen overflow-y-hidden bg-primary d-none d-lg-flex flex-column">
      ...
      <a class="d-block" href="{}">
        <img src="https://preview.webpixels.io/web/img/logos/clever-light.svg" class="h-10" alt="..."></img>
      </a>
        ...
        <div class="col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0">
          ...
          <form>
            <div class="mb-5">
              ...
              <input type="email" class="form-control form-control-muted" id="email"></input>
            </div>
            <div class="mb-5">
              <label class="form-label" for="password">Password</label>
              <input type="password" class="form-control form-control-muted" id="password" autocomplete="current-password"></input>
            </div>
            <div class="mb-5">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="check_example" id="check_example"></input>
